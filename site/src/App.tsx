...
const GITHUB_URL = "https://github.com/Withso/0docs";
const RAILWAY_URL = "https://railway.com/deploy/0docs";
...
const RailwayIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
    <rect x="5" y="6" width="11" height="2.2" rx="1.1" />
    <rect x="3" y="11" width="18" height="2.2" rx="1.1" />
    <rect x="8" y="16" width="11" height="2.2" rx="1.1" />
  </svg>
);
    ...
    <header className="relative z-10 flex-shrink-0 h-14 flex items-center justify-between px-6 lg:px-10 border-b border-border/60 backdrop-blur-sm bg-background/70">
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="h-8 px-3.5 text-[13px] rounded-md inline-flex items-center gap-1.5 font-medium text-white hover:opacity-90 transition-opacity"
          style={{ background: "#5061FF" }}
        >
          <RailwayIcon className="h-3.5 w-3.5" />
          Deploy on Railway
        </a>
      </div>
    </header>
      ...
      <div className="flex flex-col items-center text-center flex-shrink-0">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="h-10 px-5 rounded-lg inline-flex items-center gap-2 font-medium text-[14px] text-white hover:opacity-90 transition-opacity"
            style={{ background: "#5061FF" }}
          >
